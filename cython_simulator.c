/* Generated by Cython 0.19.2 on Fri Dec 06 12:09:06 2013 */
...
static PyObject *__pyx_pf_16cython_simulator_2cy_scanDistance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_dist, int __pyx_v_x, int __pyx_v_y, int __pyx_v_theta); /* proto */
...
static char __pyx_k_15[] = "E:\\Google Drive\\Inside the Box\\Programming\\Testing with C\\Again\\cython_simulator.pyx";
...
static PyObject *__pyx_pw_16cython_simulator_3cy_scanDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__input_dist,&__pyx_n_s__x,&__pyx_n_s__y,&__pyx_n_s__theta,0};
    PyObject* values[4] = {0,0,0,0};
    if (unlikely(__pyx_kwds)) {
      Py_ssize_t kw_args;
      const Py_ssize_t pos_args = PyTuple_GET_SIZE(__pyx_args);
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
    ...
    __pyx_v_x = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_x == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_y = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_y == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_theta = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_theta == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  ...
  __pyx_r = __pyx_pf_16cython_simulator_2cy_scanDistance(__pyx_self, __pyx_v_input_dist, __pyx_v_x, __pyx_v_y, __pyx_v_theta);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_16cython_simulator_2cy_scanDistance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_dist, int __pyx_v_x, int __pyx_v_y, int __pyx_v_theta) {
 ...
 */
  ...
  scanDistance((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_input_dist.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_input_dist.diminfo[0].strides))), __pyx_v_x, __pyx_v_y, __pyx_v_theta);
 ...
 *     Takes a measurement between the xy coords of the robot and obstacles around the robot in 1 degree increments and returns an array
 */
  __pyx_k_tuple_16 = PyTuple_Pack(4, ((PyObject *)__pyx_n_s__input_dist), ((PyObject *)__pyx_n_s__x), ((PyObject *)__pyx_n_s__y), ((PyObject *)__pyx_n_s__theta)); if (unlikely(!__pyx_k_tuple_16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
