/* Generated by Cython 0.19.2 on Sat Dec 07 23:25:22 2013 */
...
static PyObject *__pyx_pf_16cython_simulator_2cy_scanDistance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_dist, PyArrayObject *__pyx_v_input_sim_map, int __pyx_v_x, int __pyx_v_y, int __pyx_v_theta) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_dist.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_dist, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  ...
  scanDistance((&(*__Pyx_BufPtrCContig1d(double *, __pyx_pybuffernd_input_dist.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_input_dist.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_input_sim_map.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_input_sim_map.diminfo[1].strides))), __pyx_v_x, __pyx_v_y, __pyx_v_theta);
