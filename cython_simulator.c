/* Generated by Cython 0.19.2 on Wed Dec 11 21:02:12 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__cython_simulator
#define __PYX_HAVE_API__cython_simulator
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'cython_simulator' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_int = { "int", NULL, sizeof(int), { 0 }, 0, IS_UNSIGNED(int) ? 'U' : 'I', IS_UNSIGNED(int), 0 };
#define __Pyx_MODULE_NAME "cython_simulator"
int __pyx_module_is_main_cython_simulator = 0;

/* Implementation of 'cython_simulator' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_16cython_simulator_cy_buildMap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_sim_map, int __pyx_v_num_rows, int __pyx_v_num_cols, int __pyx_v_cell_size); /* proto */
static PyObject *__pyx_pf_16cython_simulator_2cy_scanDistance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_dist, PyArrayObject *__pyx_v_input_sim_map, int __pyx_v_x, int __pyx_v_y, int __pyx_v_theta); /* proto */
...
static char __pyx_k_15[] = "E:\\Google Drive\\Inside the Box\\Programming\\Testing with C\\Again\\BotController\\cython_simulator.pyx";
...
static char __pyx_k__cell_size[] = "cell_size";
static char __pyx_k__ValueError[] = "ValueError";
static char __pyx_k____import__[] = "__import__";
static char __pyx_k__input_dist[] = "input_dist";
static char __pyx_k__cy_buildMap[] = "cy_buildMap";
static char __pyx_k__RuntimeError[] = "RuntimeError";
static char __pyx_k__input_sim_map[] = "input_sim_map";
static char __pyx_k____pyx_getbuffer[] = "__pyx_getbuffer";
static char __pyx_k__cy_scanDistance[] = "cy_scanDistance";
...
static PyObject *__pyx_n_s__cell_size;
static PyObject *__pyx_n_s__cy_buildMap;
static PyObject *__pyx_n_s__cy_scanDistance;
static PyObject *__pyx_n_s__cython_simulator;
static PyObject *__pyx_n_s__input_dist;
static PyObject *__pyx_n_s__input_sim_map;
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_simulator_1cy_buildMap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_16cython_simulator_cy_buildMap[] = "\n    Builds a map that has x rows and y columns with cell size\n    ";
static PyMethodDef __pyx_mdef_16cython_simulator_1cy_buildMap = {__Pyx_NAMESTR("cy_buildMap"), (PyCFunction)__pyx_pw_16cython_simulator_1cy_buildMap, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_16cython_simulator_cy_buildMap)};
static PyObject *__pyx_pw_16cython_simulator_1cy_buildMap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_input_sim_map = 0;
  int __pyx_v_num_rows;
  int __pyx_v_num_cols;
  int __pyx_v_cell_size;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cy_buildMap (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__input_sim_map,&__pyx_n_s__num_rows,&__pyx_n_s__num_cols,&__pyx_n_s__cell_size,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__input_sim_map)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__num_rows)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_buildMap", 1, 4, 4, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__num_cols)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_buildMap", 1, 4, 4, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__cell_size)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_buildMap", 1, 4, 4, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_buildMap") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_input_sim_map = ((PyArrayObject *)values[0]);
    __pyx_v_num_rows = __Pyx_PyInt_AsInt(values[1]); if (unlikely((__pyx_v_num_rows == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_num_cols = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_num_cols == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_cell_size = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_cell_size == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_buildMap", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_simulator.cy_buildMap", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_sim_map), __pyx_ptype_5numpy_ndarray, 1, "input_sim_map", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_16cython_simulator_cy_buildMap(__pyx_self, __pyx_v_input_sim_map, __pyx_v_num_rows, __pyx_v_num_cols, __pyx_v_cell_size);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_16cython_simulator_cy_buildMap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_sim_map, int __pyx_v_num_rows, int __pyx_v_num_cols, int __pyx_v_cell_size) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_input_sim_map;
  __Pyx_Buffer __pyx_pybuffer_input_sim_map;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("cy_buildMap", 0);
  __pyx_pybuffer_input_sim_map.pybuffer.buf = NULL;
  __pyx_pybuffer_input_sim_map.refcount = 0;
  __pyx_pybuffernd_input_sim_map.data = NULL;
  __pyx_pybuffernd_input_sim_map.rcbuffer = &__pyx_pybuffer_input_sim_map;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_sim_map, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_input_sim_map.diminfo[0].strides = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_input_sim_map.diminfo[0].shape = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_input_sim_map.diminfo[1].strides = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_input_sim_map.diminfo[1].shape = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.shape[1];

  /* "cython_simulator.pyx":13
 *     Builds a map that has x rows and y columns with cell size
 *     """
 ...
 */
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_pybuffernd_input_sim_map.diminfo[0].shape;
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_pybuffernd_input_sim_map.diminfo[0].shape)) __pyx_t_3 = 0;
  if (__pyx_t_2 < 0) {
    __pyx_t_2 += __pyx_pybuffernd_input_sim_map.diminfo[1].shape;
    if (unlikely(__pyx_t_2 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_2 >= __pyx_pybuffernd_input_sim_map.diminfo[1].shape)) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  createMap((&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_input_sim_map.diminfo[0].strides, __pyx_t_2, __pyx_pybuffernd_input_sim_map.diminfo[1].strides))), __pyx_v_num_rows, __pyx_v_num_cols, __pyx_v_cell_size);
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_16cython_simulator_3cy_scanDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_16cython_simulator_2cy_scanDistance[] = "\n    Takes a measurement between the xy coords of the robot and obstacles around the robot in 1 degree increments and returns an array\n    ";
static PyMethodDef __pyx_mdef_16cython_simulator_3cy_scanDistance = {__Pyx_NAMESTR("cy_scanDistance"), (PyCFunction)__pyx_pw_16cython_simulator_3cy_scanDistance, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_16cython_simulator_2cy_scanDistance)};
static PyObject *__pyx_pw_16cython_simulator_3cy_scanDistance(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_input_dist = 0;
  PyArrayObject *__pyx_v_input_sim_map = 0;
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_theta;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cy_scanDistance (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__input_dist,&__pyx_n_s__input_sim_map,&__pyx_n_s__x,&__pyx_n_s__y,&__pyx_n_s__theta,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__input_dist)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__input_sim_map)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 5, 5, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__x)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 5, 5, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__y)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 5, 5, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 5, 5, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_scanDistance") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_input_dist = ((PyArrayObject *)values[0]);
    __pyx_v_input_sim_map = ((PyArrayObject *)values[1]);
    __pyx_v_x = __Pyx_PyInt_AsInt(values[2]); if (unlikely((__pyx_v_x == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_y = __Pyx_PyInt_AsInt(values[3]); if (unlikely((__pyx_v_y == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_theta = __Pyx_PyInt_AsInt(values[4]); if (unlikely((__pyx_v_theta == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_scanDistance", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_simulator.cy_scanDistance", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_dist), __pyx_ptype_5numpy_ndarray, 1, "input_dist", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_sim_map), __pyx_ptype_5numpy_ndarray, 1, "input_sim_map", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_16cython_simulator_2cy_scanDistance(__pyx_self, __pyx_v_input_dist, __pyx_v_input_sim_map, __pyx_v_x, __pyx_v_y, __pyx_v_theta);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_16cython_simulator_2cy_scanDistance(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_dist, PyArrayObject *__pyx_v_input_sim_map, int __pyx_v_x, int __pyx_v_y, int __pyx_v_theta) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_input_dist;
  __Pyx_Buffer __pyx_pybuffer_input_dist;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_input_sim_map;
  __Pyx_Buffer __pyx_pybuffer_input_sim_map;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("cy_scanDistance", 0);
  __pyx_pybuffer_input_dist.pybuffer.buf = NULL;
  __pyx_pybuffer_input_dist.refcount = 0;
  __pyx_pybuffernd_input_dist.data = NULL;
  __pyx_pybuffernd_input_dist.rcbuffer = &__pyx_pybuffer_input_dist;
  __pyx_pybuffer_input_sim_map.pybuffer.buf = NULL;
  __pyx_pybuffer_input_sim_map.refcount = 0;
  __pyx_pybuffernd_input_sim_map.data = NULL;
  __pyx_pybuffernd_input_sim_map.rcbuffer = &__pyx_pybuffer_input_sim_map;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_dist.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_dist, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_input_dist.diminfo[0].strides = __pyx_pybuffernd_input_dist.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_input_dist.diminfo[0].shape = __pyx_pybuffernd_input_dist.rcbuffer->pybuffer.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_sim_map, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_input_sim_map.diminfo[0].strides = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_input_sim_map.diminfo[0].shape = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_input_sim_map.diminfo[1].strides = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_input_sim_map.diminfo[1].shape = __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.shape[1];

  /* "cython_simulator.pyx":19
 *     Takes a measurement between the xy coords of the robot and obstacles around the robot in 1 degree increments and returns an array
 *     """
 ...
 */
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_1 < 0) {
    __pyx_t_1 += __pyx_pybuffernd_input_dist.diminfo[0].shape;
    if (unlikely(__pyx_t_1 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_1 >= __pyx_pybuffernd_input_dist.diminfo[0].shape)) __pyx_t_2 = 0;
  ...
  __pyx_t_2 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_pybuffernd_input_sim_map.diminfo[0].shape;
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_2 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_pybuffernd_input_sim_map.diminfo[0].shape)) __pyx_t_2 = 0;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_pybuffernd_input_sim_map.diminfo[1].shape;
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_2 = 1;
  } else if (unlikely(__pyx_t_4 >= __pyx_pybuffernd_input_sim_map.diminfo[1].shape)) __pyx_t_2 = 1;
  if (unlikely(__pyx_t_2 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_2);
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 19; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  scanDistance((&(*__Pyx_BufPtrCContig1d(int *, __pyx_pybuffernd_input_dist.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_input_dist.diminfo[0].strides))), (&(*__Pyx_BufPtrCContig2d(double *, __pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer.buf, __pyx_t_3, __pyx_pybuffernd_input_sim_map.diminfo[0].strides, __pyx_t_4, __pyx_pybuffernd_input_sim_map.diminfo[1].strides))), __pyx_v_x, __pyx_v_y, __pyx_v_theta);
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    __Pyx_ErrFetch(&__pyx_type, &__pyx_value, &__pyx_tb);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_input_dist.rcbuffer->pybuffer);
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_input_sim_map.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("cython_simulator.cy_scanDistance", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("cython_simulator"),
    0, /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__cell_size, __pyx_k__cell_size, sizeof(__pyx_k__cell_size), 0, 0, 1, 1},
  {&__pyx_n_s__cy_buildMap, __pyx_k__cy_buildMap, sizeof(__pyx_k__cy_buildMap), 0, 0, 1, 1},
  {&__pyx_n_s__cy_scanDistance, __pyx_k__cy_scanDistance, sizeof(__pyx_k__cy_scanDistance), 0, 0, 1, 1},
  {&__pyx_n_s__cython_simulator, __pyx_k__cython_simulator, sizeof(__pyx_k__cython_simulator), 0, 0, 1, 1},
  {&__pyx_n_s__input_dist, __pyx_k__input_dist, sizeof(__pyx_k__input_dist), 0, 0, 1, 1},
  {&__pyx_n_s__input_sim_map, __pyx_k__input_sim_map, sizeof(__pyx_k__input_sim_map), 0, 0, 1, 1},
 ...
 *     Builds a map that has x rows and y columns with cell size
 */
  __pyx_k_tuple_13 = PyTuple_Pack(4, ((PyObject *)__pyx_n_s__input_sim_map), ((PyObject *)__pyx_n_s__num_rows), ((PyObject *)__pyx_n_s__num_cols), ((PyObject *)__pyx_n_s__cell_size)); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(4, 0, 4, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__cy_buildMap, 9, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 *     Takes a measurement between the xy coords of the robot and obstacles around the robot in 1 degree increments and returns an array
 */
  __pyx_k_tuple_16 = PyTuple_Pack(5, ((PyObject *)__pyx_n_s__input_dist), ((PyObject *)__pyx_n_s__input_sim_map), ((PyObject *)__pyx_n_s__x), ((PyObject *)__pyx_n_s__y), ((PyObject *)__pyx_n_s__theta)); if (unlikely(!__pyx_k_tuple_16)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_16);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_16));
  __pyx_k_codeobj_17 = (PyObject*)__Pyx_PyCode_New(5, 0, 5, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__cy_scanDistance, 15, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initcython_simulator(void); /*proto*/
PyMODINIT_FUNC initcython_simulator(void)
#else
PyMODINIT_FUNC PyInit_cython_simulator(void); /*proto*/
PyMODINIT_FUNC PyInit_cython_simulator(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_cython_simulator(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("cython_simulator"), __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "cython_simulator")) {
      if (unlikely(PyDict_SetItemString(modules, "cython_simulator", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  ...
  #endif
  if (__pyx_module_is_main_cython_simulator) {
 ...
 *     Builds a map that has x rows and y columns with cell size
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16cython_simulator_1cy_buildMap, NULL, __pyx_n_s__cython_simulator); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__cy_buildMap, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 9; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     Takes a measurement between the xy coords of the robot and obstacles around the robot in 1 degree increments and returns an array
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_16cython_simulator_3cy_scanDistance, NULL, __pyx_n_s__cython_simulator); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__cy_scanDistance, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "cython_simulator.pyx":1
 * import cython             # <<<<<<<<<<<<<<
 * import numpy as np
 * cimport numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init cython_simulator", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cython_simulator");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
