/* Generated by Cython 0.19.2 on Thu Dec 05 22:04:18 2013 */
...
static char __pyx_k_15[] = "E:\\Google Drive\\Inside the Box\\Programming\\Testing with C\\Again\\cython_process_array.pyx";
static char __pyx_k_16[] = "cython_process_array";
...
static PyObject *__pyx_pw_20cython_process_array_1cy_processArray(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("cy_processArray (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__input)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__dist)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__origx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__origy)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__theta)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cy_processArray") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_origx = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_origx == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_origy = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_origy == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_theta = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_theta == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("cy_processArray", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("cython_process_array.cy_processArray", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_GPS), __pyx_ptype_5numpy_ndarray, 1, "input_GPS", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input), __pyx_ptype_5numpy_ndarray, 1, "input", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_20cython_process_array_cy_processArray(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_GPS, PyArrayObject *__pyx_v_input, PyArrayObject *__pyx_v_dist, double __pyx_v_origx, double __pyx_v_origy, double __pyx_v_theta) {
  ...
  __pyx_pybuffernd_dist.rcbuffer = &__pyx_pybuffer_dist;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_GPS.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_GPS, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input.rcbuffer->pybuffer, (PyObject*)__pyx_v_input, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_dist.rcbuffer->pybuffer, (PyObject*)__pyx_v_dist, &__Pyx_TypeInfo_int, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
...
static PyObject *__pyx_pw_20cython_process_array_3cy_initArray(PyObject *__pyx_self, PyObject *__pyx_v_input_GPS) {
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_input_GPS), __pyx_ptype_5numpy_ndarray, 1, "input_GPS", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyObject *__pyx_pf_20cython_process_array_2cy_initArray(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_input_GPS) {
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_input_GPS.rcbuffer->pybuffer, (PyObject*)__pyx_v_input_GPS, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_input_GPS.diminfo[0].strides = __pyx_pybuffernd_input_GPS.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_input_GPS.diminfo[0].shape = __pyx_pybuffernd_input_GPS.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_input_GPS.diminfo[1].strides = __pyx_pybuffernd_input_GPS.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_input_GPS.diminfo[1].shape = __pyx_pybuffernd_input_GPS.rcbuffer->pybuffer.shape[1];

  /* "cython_process_array.pyx":15
 * 
 * def cy_initArray(np.ndarray[double, ndim=2, mode="c"] input_GPS):
 * 	initialize(&input_GPS[0,0])             # <<<<<<<<<<<<<<
 */
 ...
 * 
 */
  __pyx_k_tuple_13 = PyTuple_Pack(6, ((PyObject *)__pyx_n_s__input_GPS), ((PyObject *)__pyx_n_s__input), ((PyObject *)__pyx_n_s__dist), ((PyObject *)__pyx_n_s__origx), ((PyObject *)__pyx_n_s__origy), ((PyObject *)__pyx_n_s__theta)); if (unlikely(!__pyx_k_tuple_13)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_13);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_13));
  __pyx_k_codeobj_14 = (PyObject*)__Pyx_PyCode_New(6, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_13, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__cy_processArray, 11, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_14)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 * 	initialize(&input_GPS[0,0])
 */
  __pyx_k_tuple_17 = PyTuple_Pack(1, ((PyObject *)__pyx_n_s__input_GPS)); if (unlikely(!__pyx_k_tuple_17)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_k_tuple_17);
  __Pyx_GIVEREF(((PyObject *)__pyx_k_tuple_17));
  __pyx_k_codeobj_18 = (PyObject*)__Pyx_PyCode_New(1, 0, 1, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_k_tuple_17, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_15, __pyx_n_s__cy_initArray, 14, __pyx_empty_bytes); if (unlikely(!__pyx_k_codeobj_18)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20cython_process_array_1cy_processArray, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__cy_processArray, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 * 	initialize(&input_GPS[0,0])
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_20cython_process_array_3cy_initArray, NULL, __pyx_n_s_16); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s__cy_initArray, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
